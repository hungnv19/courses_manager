                            ...
                            <div class="navigation-area">
                                <div class="row">
                                    <div
                                        ...
                                        <div class="thumb">
                                            <a href="#">
                                                <img class="img-fluid" src="client/img/post/preview.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="arrow">
                                    ...
                                    <div
                                        ...
                                        <div class="thumb">
                                            <a href="#">
                                                <img class="img-fluid" src="client/img/post/next.png" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="client/img/blog/comment_1.png" alt="">
                                        </div>
                                        <div class="desc">
                                            <p class="comment">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="client/img/blog/comment_2.png" alt="">
                                        </div>
                                        <div class="desc">
                                            <p class="comment">
                                                Multiply sea night grass fourth day sea lesser rule open subdue female
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="client/img/blog/comment_3.png" alt="">
                                        </div>
                                        <div class="desc">
                                            <p class="comment">
                                                Multiply sea night grass fourth day sea lesser rule open subdue female
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="client/img/post/post_2.png" alt="post">
                                    <div class="media-body">
                                        <a href="blog_details.html">
                                ...
                                <div class="media post_item">
                                    <img src="client/img/post/post_3.png" alt="post">
                                    <div class="media-body">
                                        <a href="blog_details.html">
                                ...
                                <div class="media post_item">
                                    <img src="client/img/post/post_4.png" alt="post">
                                    <div class="media-body">
                                        <a href="blog_details.html">
                            ...
                            <aside class="single_sidebar_widget instagram_feeds">
                                ...
                                <ul class="instagram_row flex-wrap">
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="client/img/post/post_5.png" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="client/img/post/post_6.png" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="client/img/post/post_7.png" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="client/img/post/post_8.png" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="client/img/post/post_9.png" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="client/img/post/post_10.png" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </aside>
