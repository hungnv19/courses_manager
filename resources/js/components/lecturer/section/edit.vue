        ...
        <div class="card-body">
          ...
          >
            ...
            >
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name"
                  >Details <span class="required-label"> *</span></label
                >
                <div class="col-sm-10">
                  <Field
                    as="textarea"
      ...
      en: {
        fields: {
          ...
          description: {
            ...
            max: "The description may not be greater than 128.",
          },
          details: {
            required: "The details field is required.",
            max: "The details may not be greater than 128.",
          },
        },
      },
    };
